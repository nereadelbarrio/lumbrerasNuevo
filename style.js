	...
	lumbrerasNuevoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Autoevaluación 1 secundaria', element: 'h4', attributes: { 'class': 'bck-title10'} },
				{ name: 'Ampliación 1 secundaria', element: 'h4', attributes: { 'class': 'bck-title11'} },
				{ name: 'Refuerzo 1 secundaria', element: 'h4', attributes: { 'class': 'bck-title12'} },
				{ name: 'Autoevaluación 2 secundaria', element: 'h4', attributes: { 'class': 'bck-title13'} },
				{ name: 'Ampliación 2 secundaria', element: 'h4', attributes: { 'class': 'bck-title14'} },
				{ name: 'Refuerzo 2 secundaria', element: 'h4', attributes: { 'class': 'bck-title15'} },
				{ name: 'Autoevaluación 3 secundaria', element: 'h4', attributes: { 'class': 'bck-title16'} },
				{ name: 'Ampliación 3 secundaria', element: 'h4', attributes: { 'class': 'bck-title17'} },
				{ name: 'Refuerzo 3 secundaria', element: 'h4', attributes: { 'class': 'bck-title18'} },
				{ name: 'Autoevaluación 4 secundaria', element: 'h4', attributes: { 'class': 'bck-title19'} },
				{ name: 'Ampliación 4 secundaria', element: 'h4', attributes: { 'class': 'bck-title20'} },
				{ name: 'Refuerzo 4 secundaria', element: 'h4', attributes: { 'class': 'bck-title21'} },
				{ name: 'Autoevaluación 5 secundaria', element: 'h4', attributes: { 'class': 'bck-title22'} },
				{ name: 'Ampliación 5 secundaria', element: 'h4', attributes: { 'class': 'bck-title23'} },
				{ name: 'Refuerzo 5 secundaria', element: 'h4', attributes: { 'class': 'bck-title24'} },
				...
				{ name: 'Lista Desordenada 7', element: 'ul', attributes: { 'class': 'bck-ul-7'} },
				{ name: 'Lista Desordenada 8', element: 'ul', attributes: { 'class': 'bck-ul-8'} },
